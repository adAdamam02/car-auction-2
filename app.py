...
def index():
    ...
    with conn:
        with conn.cursor() as cursor:
            ...
            return render_template("index.html", info=cursor.fetchall(), days=days)
        ...
        with conn:
            with conn.cursor() as cursor:
                ...
                if 'complete-purchase' in request.form:
                    ...
                    previous_inserts = cursor.execute("SELECT * FROM purchases WHERE user_id = %s AND insert_id = %s", (user_id, insert_id))
